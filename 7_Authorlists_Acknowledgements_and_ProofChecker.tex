...
\begin{figure}[htb]
  ...
  The first five entries in the list are GitLab projects. \GSnote{}{They're not all gitlab projects? Just crop this to show only the first five then. I'm confused here. Expand this caption more too.}}%
...
\begin{figure}[htb]
  ...
  \caption{ATLAS collaboration proofs main page. \GSnote{}{Please expand caption with more detail... e.g. what are the columns?}}
