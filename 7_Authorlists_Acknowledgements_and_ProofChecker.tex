...
Another reason is that words extracted from a PDF file donât follow a specific coding convention:
...
\item authors with inconsistent punctuation. This section points out differences between original and target references authorsâ first names punctuation,
...
\begin{table}[htb]
  ...
  \midrule
  \textbf{Institute as written on the journalâs author list} \\
