...
The \Class{Workflow} class was developed based on the concept of Directed Cyclic Graphs (DCG), that encompasses the relation between objects. In this context, objects are called nodes and the relation between them are called edges, that can be a directional flow or not. To represent this concept through a codified depiction, some classes were created.
...
Finally, email notifications to be sent are defined through templates and specifying when they will be triggered.
